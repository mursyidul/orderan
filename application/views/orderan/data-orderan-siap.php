    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('orderan_siap/change_status_siap_kirim') ?>" class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
                <div class="col-lg-12">
                    <!-- <div id="tampilan"></div> -->
                    <div id="my_photo_booth<?php echo $i; ?>">
                        <!-- <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4"> -->
                                <center>
                                <div id="results<?php echo $i; ?>" style="display:none">
                                </div></center>
                            <!-- </div>
                            </center>
                            <div class="col-md-4"></div> -->
                ...
                <center>
                    <div class="col-sm-12" id="button_hilang">
                        <div id="pre_take_buttons">
                            <button type="button" class="btn btn-primary" onClick="save_photo<?php echo $i; ?>()"><i class="fa fa-camera"> Foto</i></button>
                        </div>
                    </div>

                    <div class="col-sm-12" id="button_siap" style="display: none">
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="picture" class="form-control image-tag<?php echo $i; ?>">
...
<script type="text/javascript">
    ...
    function save_photo<?php echo $i ?>() {
        // actually snap photo (from preview freeze) and display it
        Webcam.snap( function(data_uri) {
            // display results in page
            $(".image-tag<?php echo $i; ?>").val(data_uri);
            document.getElementById('results<?php echo $i; ?>').innerHTML = 
                '<img class="img-fluid" src="'+data_uri+'"/><br/><br/>';
            // shut down camera, stop capturing
            Webcam.reset();
            // show results, hide photo booth
            document.getElementById('results<?php echo $i; ?>').style.display = '';
            document.getElementById('button_siap').style.display = '';
            document.getElementById('button_hilang').style.display = 'none';
            document.getElementById('my_photo_booth<?php echo $i; ?>').style.display = 'none';
        } );
    }
</script>
<?php $i++; } ?>
