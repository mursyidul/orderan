                    ...
                    <form action="<?php echo base_url('schedule/tambah_schedule'); ?>" method="post" role="form">
                        <div class="table-responsive">
                            ...
                            <table id="tableschedule" class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tbody>
                                    ...
                                    $i=1; foreach ($user as $s) { ?>
                                        <tr>
                                            ...
                                            <td><center><input type="radio" name="shift_kerja<?php echo $id_user ?>" value="OFF" <?php if($shift_kerja=='OFF') echo 'checked' ?>></center></td>
                                            <td><center><input type="radio" name="shift_kerja<?php echo $id_user ?>" value="SHIFT_1" <?php if($shift_kerja == "SHIFT_1"){echo "checked";} ?>></center></td>
                                            <td><center><input type="radio" name="shift_kerja<?php echo $id_user ?>" value="SHIFT_2" <?php if($shift_kerja == "SHIFT_2"){echo "checked";} ?>></center></td>
                                            <td><center><input type="radio" name="shift_kerja<?php echo $id_user ?>" value="SHIFT_3" <?php if($shift_kerja == "SHIFT_3"){echo "checked";} ?>></center></td>
                                            <td><center><input type="radio" name="shift_kerja<?php echo $id_user ?>" value="NON_SHIFT" <?php if($shift_kerja == "NON_SHIFT"){echo "checked";} ?>></center></td>
                                            <?php 
                                                        } 
                                                    }
                                                }else{
                                            ?>
                                                    ...
                                                    <td><center><input type="radio" checked name="shift_kerja<?php echo $s->id_user ?>" value="OFF" required></center></td>
                                                    <td><center><input type="radio" name="shift_kerja<?php echo $s->id_user ?>" value="SHIFT_1" required></center></td>
                                                    <td><center><input type="radio" name="shift_kerja<?php echo $s->id_user ?>" value="SHIFT_2" required></center></td>
                                                    <td><center><input type="radio" name="shift_kerja<?php echo $s->id_user ?>" value="SHIFT_3" required></center></td>
                                                    <td><center><input type="radio" name="shift_kerja<?php echo $s->id_user ?>" value="NON_SHIFT" required></center></td>
                                            <?php } ?> 
                                        </tr>                   
                                    <?php $i++; } ?>
                                    <?php } else {
                                ...
                                <button class="btn btn-info pull-right" id="btn_add_data">
