...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo base_url('assets/unify/favicon.ico') ?>">
    <!-- Google Fonts -->
    <link rel="stylesheet" href="//fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">

    <!-- CSS Global Compulsory -->
    <link href="<?php echo base_url('assets/unify/vendor/bootstrap/bootstrap.min.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/unify/vendor/icon-line/css/simple-line-icons.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/unify/vendor/icon-line-pro/style.css') ?>" rel="stylesheet">

    <!-- CSS Implementing Plugins -->
    <link href="<?php echo base_url('assets/unify/vendor/icon-awesome/css/font-awesome.min.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/unify/vendor/icon-hs/style.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/unify/vendor/hamburgers/hamburgers.min.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/unify/vendor/chosen/chosen.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/unify/vendor/slick-carousel/slick/slick.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/unify/vendor/master-slider/source/assets/css/masterslider.main.css') ?>" rel="stylesheet">

    <!-- CSS Template -->
    <link href="<?php echo base_url('assets/unify/css/styles.op-real-estate.css') ?>" rel="stylesheet">

    <!-- CSS Customization -->
    <link href="<?php echo base_url('assets/unify/css/custom.css') ?>" rel="stylesheet">
  </head>
  ...
  <body>
    <main class="g-pt-110 g-pt-120--md g-pt-170--lg">
      ...
      <section id="gallery">
        <div class="js-carousel u-carousel-v1 u-carousel-v3 g-parent"
          ...
          <div class="js-slide g-pos-rel g-height-100vh g-min-height-450 g-bg-img-hero" style="background-image: url(assets/img-temp/1200x802/img1.jpg);">
            <!-- Article Content -->
          ...
          <div class="js-slide g-pos-rel g-height-100vh g-min-height-450 g-bg-img-hero" style="background-image: url(assets/img-temp/1200x802/img2.jpg);">
            <!-- Article Content -->
            <div class="g-absolute-centered g-width-90x g-width-485--lg g-bg-primary-opacity-0_9 g-rounded-4 g-pa-30">
              <!-- Article Title -->
              <h3 class="text-uppercase g-font-weight-700 g-font-size-16 g-mb-20">
          ...
          <div class="js-slide g-pos-rel g-height-100vh g-min-height-450 g-bg-img-hero" style="background-image: url(assets/img-temp/1200x802/img3.jpg);">
            <!-- Article Content -->
            <div class="g-absolute-centered g-width-90x g-width-485--lg g-bg-primary-opacity-0_9 g-rounded-4 g-pa-30">
              <!-- Article Title -->
              <h3 class="text-uppercase g-font-weight-700 g-font-size-16 g-mb-20">
          ...
          <div class="js-slide g-pos-rel g-height-100vh g-min-height-450 g-bg-img-hero" style="background-image: url(assets/img-temp/1200x802/img4.jpg);">
            <!-- Article Content -->
            <div class="g-absolute-centered g-width-90x g-width-485--lg g-bg-primary-opacity-0_9 g-rounded-4 g-pa-30">
              <!-- Article Title -->
              <h3 class="text-uppercase g-font-weight-700 g-font-size-16 g-mb-20">
    ...
    <script src="<?php echo base_url('assets/unify/vendor/jquery/jquery.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/vendor/jquery-migrate/jquery-migrate.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/vendor/popper.js/popper.min.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/vendor/bootstrap/bootstrap.min.js'); ?>"></script>

    <!-- JS Implementing Plugins -->
    <script src="<?php echo base_url('assets/unify/vendor/appear.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/vendor/slick-carousel/slick/slick.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/vendor/master-slider/source/assets/js/masterslider.min.js'); ?>"></script>

    <!-- JS Unify -->
    <script src="<?php echo base_url('assets/unify/js/hs.core.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/js/components/hs.header.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/js/helpers/hs.hamburgers.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/js/components/hs.scroll-nav.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/js/components/hs.rating.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/js/components/hs.carousel.js'); ?>"></script>
    <script src="<?php echo base_url('assets/unify/js/components/hs.go-to.js'); ?>"></script>

    <!-- JS Customization -->
    <script src="<?php echo base_url('assets/unify/js/custom.js'); ?>"></script>
